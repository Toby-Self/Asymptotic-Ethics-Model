...
in federated_ai_commons_model.py. Each function is a pure extraction of logic
...
block, against the real FederatedAICommonsModel producing the same verdict
...
if __name__ == "__main__":
    ...
    m = FederatedAICommonsModel(100, 6, seed=1, coupled_governance=True,
    ...
    m2 = FederatedAICommonsModel(100, 6, seed=1, federated_mode=True, debug_assertions=True)
    ...
    m3 = FederatedAICommonsModel(100, 6, seed=1, contested_sites_enabled=True,
